...
static PartTable def_part_table =
{
    ...
    },
    {
        ...
        start_head: 0x00,
        start_sec: 0x1,
        start_cyl: 0xFF, // extended partition start cylinder (BR location)
        part_type: 0x05,
        end_head: 0xFF,
        end_sec: 0xFF,
        end_cyl: 0xFF,
...
static unsigned long def_log_part_br_cyl[] = {0x0780, 0x0F00};
